...
function App() {
  ...
  return (
    <div className='w-full h-screen p-4 duration-200' style={{backgroundColor: color}}>
      
       
      <div className='fixed font-semibold flex flex-wrap justify-center bottom-12 inset-x-0 px-2'>
